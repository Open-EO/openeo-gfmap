...
BASE_WEATHER_MAPPING = {'dewpoint-temperature':'A5-dewtemp',
...
def build_generic_extractor(
    backend_context: BackendContext, bands: list, fetch_type: FetchType, collection_name: str, **params
) -> CollectionFetcher:
